...
const HeroSectionTwo = () => {
	return (
		...
		bg-gradient-to-bl from-orange-100 via-white to-orange-100 text-center p-[14px]">
			<h3 className="font-extrabold text-[24px] text-black">Say Bye To Flawed Yoruba Proverbs</h3>
			<p className="mt-[10px] text-[14px] leading-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt quis mollitia numquam nihil ab.</p>
